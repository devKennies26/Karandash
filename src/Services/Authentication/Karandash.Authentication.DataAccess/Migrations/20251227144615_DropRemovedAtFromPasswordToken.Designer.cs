...
namespace Karandash.Authentication.DataAccess.Migrations
{
    ...
    [Migration("20251227144615_DropRemovedAtFromPasswordToken")]
    partial class DropRemovedAtFromPasswordToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Karandash.Authentication.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "System",
                            InsertedAt = new DateTime(2025, 12, 27, 14, 46, 14, 712, DateTimeKind.Utc).AddTicks(7877),
                            IsDeleted = false,
                            IsVerified = true,
